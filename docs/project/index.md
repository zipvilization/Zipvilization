...
### [`LORE_GENESIS.md`](LORE_GENESIS.md)
...
### [`TOKEN_LAUNCH.md`](TOKEN_LAUNCH.md)
...
### [`EARLY_ACCESS.md`](EARLY_ACCESS.md)
...
### [`POST_LAUNCH_GUARANTEES.md`](POST_LAUNCH_GUARANTEES.md)
...
- [Lore / Genesis](LORE_GENESIS.md) defines the nature of the world.
- [Token Launch](TOKEN_LAUNCH.md) defines how it begins.
- [Early Access](EARLY_ACCESS.md) defines how participation starts.
- [Assumptions](ASSUMPTIONS.md) and [Security](SECURITY.md) define the project's limits.
- [Treasury](TREASURY.md) defines sustainability.
- [Post-launch Guarantees](POST_LAUNCH_GUARANTEES.md) define honesty over time.
- [Communication](COMMUNICATION.md) defines how meaning is transmitted.
