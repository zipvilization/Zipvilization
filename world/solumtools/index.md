...
nav_order: 7
description: >
  SolumTools is the public observation layer of Zipvilization. It reads
  blockchain data and canonical state to expose deterministic signals about
  Solum, Colonists, Territories, Zips, time, maturity, and the evolving world.
