...
Zipvilization can define land.

It can define territorial scale.

It can define population.

It can define time.

It can define scarcity, permanence, thresholds, and deterministic rules.

But it cannot define civilization.
...
Where competition becomes possible.

Where different interests begin producing different outcomes.
...
Given the same world, Colonists may make different decisions.
...
The first domain requires specification.

The second requires possibility.

If we confuse them, we either create an incoherent system or an over-scripted world.
...
Colonists make it participatory.
...
### What gives the world native population?
