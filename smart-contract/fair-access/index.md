...
nav_order: 7
description: >
  Fair Access defines the contract-level mechanisms that constrain how Solum
  can be acquired, transferred, and concentrated. Transaction limits, wallet
  limits, and launch restrictions protect broad participation without
  guaranteeing equal outcomes.
permalink: /smart-contract/fair-access/
---
...
→ **[Return to Taxes](/smart-contract/taxes/)**  
→ **[Continue to Security](/smart-contract/security/)**
