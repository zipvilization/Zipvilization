...
nav_order: 2
description: >
  The principles that define Zipvilization and guide how the project,
  its world, technology, economy, and community should evolve.
...
The world itself may evolve in ways we cannot predict.

So before building a civilization, we need to know what should remain true.

These are the principles of Zipvilization.

They are not promises about what the civilization will become.
...
But speculation is not the purpose of Zipvilization.
...
There are no promised profits.

There is no guaranteed outcome.

There is only an invitation:

**Understand the experiment. Enter if it means something to you. Participate in what happens next.**
...
It is not the reason the system exists.
...
## 3. Rules before discretion

The fundamental rules of Zipvilization should not depend on whether someone in the project likes a particular outcome.

Where a rule can be deterministic, public, and verifiable, it should be.

This is one of the reasons blockchain matters.
...
These mechanisms should be understandable and inspectable.
...
Not by endlessly expanding the world itself.
...
## 5. Civilization should emerge, not be scripted
...
But if we decide in advance what every society will become, we are not observing a civilization emerge.
...
Inside Zipvilization, its meaning is **Permanent Nature**.

The distinction matters.

A forest does not cease to exist because no Colonist can own it.
...
## 8. Fair access matters more than maximum extraction
...
This does not mean everyone will own the same amount.

It means the beginning should give many people a meaningful opportunity to participate.

A civilization needs Colonists more than it needs whales.
...
It may become something none of us currently expect.
...
## 10. Transparency before trust

You should not need to trust a manifesto.
...
## 11. Complexity should be understandable, not hidden

Zipvilization is complex.

That is not something we need to apologize for.
...
Our responsibility is not to remove that complexity by pretending it does not exist.

Our responsibility is to make it navigable.
...
We should not pretend that we do.
...
# Principles are constraints, not predictions

These principles do not tell us what Zipvilization will become.

That would defeat the purpose.

They tell us what we are unwilling to sacrifice while discovering it.

A new technology can replace an old one.

A better implementation can replace an imperfect one.
...
The principles define the boundaries.

Now discover the system that exists inside them.
